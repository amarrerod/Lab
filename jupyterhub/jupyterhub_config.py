...
#  Default: '/opt/jupyterhub/.venv/share/jupyterhub'
# c.JupyterHub.data_files_path = '/opt/jupyterhub/.venv/share/jupyterhub'
...
c.Authenticator.admin_users = {'edusegre', 'amarrero'}
